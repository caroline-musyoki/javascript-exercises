...
/*(base) carolinemusyoki@Carolines-MacBook-Air JS-Exercises % node
...
// and why.
//
//The output did not change until I saved the file because Node runs the last saved version.
// TODO: Part four.
...
//
// Both Node and the Chrome DevTools Console executed the console.log() statement and displayed the greeting.
// Chrome DevTools ran the code directly in the browser without needing to save or run a file.
...
Error: Cannot find module '/Users/carolinemusyoki/Desktop/startupistan-practice/lesson-01.js'
  ...
  */
// Solution: I resolved the error by changing to the folder that contains lesson-01.js before running `node lesson-01.js`.
